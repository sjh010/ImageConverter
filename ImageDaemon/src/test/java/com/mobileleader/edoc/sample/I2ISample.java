...
//		System.out.println("InziI2I loadLicense result : " + retval);
		...
		String tiff1 = homePath + "D:\\convert\\sample_01.tif";
		String tiff2 = homePath + "D:\\convert\\sample_02.tif";
...
//		result = inziI2I.extractTIFF_FILE(tiff1, 1, homePath + "D:\\convert\\extractedTiff_1page.tiff");
//		System.out.println("Extract result:" + result);
//		System.out.println("Extract file path:" + homePath + "D:\\convert\\extractedTiff_1page.tiff");

		/**
		 * JPEG to TIFF
		 */
//		System.out.println("### JPEG to TIFF ###");
//		String jpg1 = homePath + "D:\\convert\\sample_jpg.jpg";
...
//
//		fileType = inziI2I.getFileType_FILE(homePath + "D:\\convert\\CF202012181656350b");
